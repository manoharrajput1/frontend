...
const Contact = () => {
  ...
  const aboutData = async () => {
    const nuser = await axios.get('https://backend-kfwe.vercel.app/about')
  ...
  const sendData = async (e) => {
    ...
    const response = await axios.post('https://backend-kfwe.vercel.app/contact', { name, email, phone, message })
